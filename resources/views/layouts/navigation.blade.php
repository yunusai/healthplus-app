            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if (Auth::user()->role == 'dokter')
                        ...
                        <x-nav-link :href="route('dokter.riwayat-pasien.index')" :active="request()->routeIs('dokter.riwayat-pasien.index')">
                            {{ __('Riwayat Pasien') }}
                        </x-nav-link>
                     @elseif(Auth::user()->role == 'pasien')
                        ...
                        <x-nav-link :href="route('pasien.riwayat-periksa.index')" :active="request()->routeIs('pasien.riwayat-periksa.index')">
                            {{ __('Riwayat Daftar ke Poli') }}
                        </x-nav-link>
                    @elseif(Auth::user()->role == 'admin')
                        <x-nav-link :href="route('admin.dashboard')" :active="request()->routeIs('admin.dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.data-dokter.index')" :active="request()->routeIs('admin.data-dokter.index')">
                            {{ __('Data Dokter') }}
                        </x-nav-link>
                        <x-nav-link :href="route('admin.data-pasien.index')" :active="request()->routeIs('admin.data-pasien.index')">
                            {{ __('Data Pasien') }}
                        </x-nav-link>
